...
<?php /* The keys come first, and the wording of the buttons last.
         Somebody opening this screen is nearly always here to paste a key in
         or to check one is there; the titles and the bank details are set
         once and then never again. They were the other way round, so the keys
         sat five cards down behind Invoices and Bank details and the screen
         looked, on arrival, exactly as it had before they were added. */ ?>
